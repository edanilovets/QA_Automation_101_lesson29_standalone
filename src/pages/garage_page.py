...
class GaragePage(BasePage):
    ...
    def open(self):
        self.logger.info("Opening Garage page")
        url = "/panel/garage"
    ...
    def add_car(self, car: Car, wait_time: int = 5):
        ...
        self.logger.info(f"Adding car {car}")
    ...
    def wait_for_number_of_cars_to_be(self, num: int = 1, wait_time: int = 5):
        self.logger.info(f"Waiting for number of cars to be {num}")
    ...
    def assert_that_car_was_added(self, car: Car, index: int = 1):
        self.logger.info("Assert that car was added")
